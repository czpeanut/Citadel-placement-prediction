...
function analyzeScores() {
  ...
  formData.append("entry.977897966", document.querySelector("#chinese").value);
  formData.append("entry.1550956144", document.querySelector("#english").value);
  formData.append("entry.1358965558", document.querySelector("#math").value);
  formData.append("entry.1044822364", document.querySelector("#science").value);
  formData.append("entry.630863529", document.querySelector("#social").value);
